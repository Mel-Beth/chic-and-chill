<?php include('../includes/header_loc.php');?>
<!-- Bannière principale -->
<section class="relative bg-[url('/site_stage/chic-and-chill/assets/images/banniere_accueil.webp')] bg-cover bg-center h-[80vh] flex items-center justify-center">
...
include('/../includes/footer_loc.php');

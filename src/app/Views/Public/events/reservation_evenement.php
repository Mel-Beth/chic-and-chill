...
<div class="relative w-full h-96 bg-cover bg-center flex justify-center items-center">
    <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center px-4">
        <h1 class="text-white text-5xl font-bold">Réserver un évènement</h1> <!-- Titre principal -->
    </div>
</div>
...
<div class="container mx-auto px-4 py-12 mt-3">
    ...
    <!-- Vérification des événements disponibles -->
    <?php if (!empty($events)) : ?>
        ...
        <script>
            // Affiche/masque les champs entreprise selon le type de client
